...
import { paginateGitHub } from '../utils/pagination.js';
...
export const fetchGithubIssuesPaginated = async (repoOwner, repoName) => {
    const issues = await paginateGitHub(`https://api.github.com/repos/${repoOwner}/${repoName}/issues?state=all`);
    return issues;
};
